...
Please consult the documentation of your virtualization solution for exposing/mapping/forwarding virtual machine ports as needed (networking parameters).

You'll need to ensure that you've got access to access the Web Interface (port 13000) and SSH (port 22).
