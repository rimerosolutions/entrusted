...
- Linux
  - Provide binaries for for [[https://musl.libc.org/][musl-libc]] systems ([[https://www.alpinelinux.org/][Alpine Linux]] and others)
  - Drop Linux [[https://appimage.org/][AppImage]] format
