...
- [ ] Investigate problems with creating Rust binaries with 100% static linking? Is this even possible?
- [ ] Look at automation scenarios and use-cases (Browser plugin, HTTP Proxy, etc.)
- [ ] Look at packaging for Linux, MacOS and Windows
- [ ] Investigate support for BSD (OpenBSD, FreeBSD & NetBSD): jails and similar other options with TCP communications??
- [ ] TODO
