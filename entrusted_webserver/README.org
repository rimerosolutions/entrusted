...
This module allows converting documents from the comfort of your Web browser.
...
Please consult the [[./api_specification/openapi.yml][OpenAPI specification]] documentation for further details: instead of looking at the plain YAML file, you can visualize it using the online [[https://editor.swagger.io/][Swagger Editor]] or [[https://openapi.tools/#documentation][several other tools]].
