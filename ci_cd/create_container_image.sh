...
podman build --force-rm --log-level info --squash-all --format docker  --platform linux/arm64/v8 --platform linux/amd64 --manifest docker.io/uycyjnzgntrn/entrusted_container:${APPVERSION} -f entrusted_container/Dockerfile .
