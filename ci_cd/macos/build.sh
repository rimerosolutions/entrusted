...
echo "The macos local build pipeline is currently broken (GUI build). Cross-compilation from Linux doesn't work, but it compiles just fine on a Mac OS machine."
...
#     EXPORT_PARAMS="export CARGO_NET_GIT_FETCH_WITH_CLI=true; export CARGO_NET_RETRY=10; export CC=x86_64-apple-darwin22.4-clang; export CXX=x86_64-apple-darwin22.4-clang++;"
#     STRIP_COMMAND="x86_64-apple-darwin22.4-strip"

#     if [ ${CPU_ARCH} != "amd64" ]
#     then
#         RUST_TARGET="aarch64-apple-darwin"
#         EXPORT_PARAMS="export CARGO_NET_GIT_FETCH_WITH_CLI=true; export CARGO_NET_RETRY=10; export CC=arm64-apple-darwin22.4-clang; export CXX=arm64-apple-darwin22.4-clang++;"    
#         ADDITIONAL_PARAMS="CARGO_TARGET_AARCH64_APPLE_DARWIN_LINKER=arm64-apple-darwin22.4-clang LIBZ_SYS_STATIC=0"
