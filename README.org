...
- If you prefer a live CD, please download the ISO image =dangerzone-livecd-<version>.iso=
...
- [-] Support serial batch conversions ([[https://github.com/rimerosolutions/dangerzone-rust/tree/spiral13][spiral13 branch]])
  - [X] In the Web user interface
  - [ ] In the graphical desktop interface    
