...
# podman rmi --force docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION}-amd64
# podman rmi --force docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION}-arm64
# podman rmi --force docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION}

# buildah manifest create docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION}
# buildah bud --squash --platform=linux/amd64 --format docker -t docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION}-amd64 -f Dockerfile.container.builder .
# buildah manifest add docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION} docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION}-amd64
# buildah bud --squash --platform=linux/arm64/v8 --format docker -t docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION}-arm64 -f Dockerfile.container.builder .
# buildah manifest add docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION} docker.io/uycyjnzgntrn/entrusted_container_builder:alpine-${ALPINE_VERSION}-arm64
