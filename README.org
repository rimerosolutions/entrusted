...
=dangerzone-rust= allows converting "potentially suspiciuous documents" into safe and trusted PDFs, without worrying too much about viruses or evil macros. *This is not a mature project*.
