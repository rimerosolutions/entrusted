...
#+begin_src conf-toml
  ...
  # Leave this to enabled by default, unless you experience random conversion failures
  seccomp-profile-disabled = false
#+end_src
...
| =seccomp_profile_disabled= | Custom [[https://docs.docker.com/engine/security/seccomp/][seccomp]] security profile for container image hardening     |
|----------------------------+-------------------------------------------------------------------|
