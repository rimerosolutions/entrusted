...
podman build --log-level info --jobs 3 --squash-all --format docker  --platform linux/arm64/v8 --platform linux/amd64 --manifest docker.io/uycyjnzgntrn/entrusted_container:${APPVERSION} -f entrusted_container/Dockerfile .
