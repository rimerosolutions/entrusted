...
|                  | =entrusted-linux-amd64-<version>.deb=   | Debian package with the Desktop and CLI clients |
|                  | =entrusted-linux-amd64-<version>.rpm=   | Redhat package with the Desktop and CLI clients |
|------------------+-----------------------------------------+-------------------------------------------------|
