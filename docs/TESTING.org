...
This describes the testing process from a Live CD of [[https://www.alpinelinux.org/][Alpine Linux]] (=aarch64/arm64= ISO image)
- We setup a [[https://www.qemu.org/][QEMU]] virtual machine from an =amd64= computer
- We don't perform a permanent installation
- I'm *assuming that you're running a Unix/Linux environment*, in my case it's a =Mac OS= host machine
