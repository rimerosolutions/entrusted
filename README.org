...
On Linux, if you prefer [[https://flatpak.org/][Flatpak]], please visit the [[https://github.com/axtloss/flatpaks][axtloss flatpaks]] project page for general instructions: The flatpak package itself is developed [[https://github.com/axtloss/flatpaks/tree/main/com.github.rimerosolutions.entrusted][here]].
