...
Most users will interact with the =dangerzone_client=, via its Desktop user interface:
...
| [[./dangerzone_l10n][dangerzone_l10n]]       | Shared library for translation features     |
|-----------------------+---------------------------------------------|
...
This project is more of a hobby at this point: it lacks testing, maturity and few features.
...
| *Incomplete*                             | UI and code polishing, probably several "obvious things"  |
|------------------------------------------+-----------------------------------------------------------|
