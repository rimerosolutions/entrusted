...
- For Mac OS users:
  - If you only care about the graphical Deskop interface, please download the file =dangerzone-darwin-amd64-<version>.dmg=
  - If you want all the available binaries, please download the file =dangerzone-darwin-amd64-<version>.zip=
- For Windows users:
  - If you prefer a conventional installer, please download the file =dangerzone-windows-amd64-<version>.exe=
  - For a portable distribution, please download the file =dangerzone-windows-amd64-<version>.zip=
- If you prefer a live CD with a Web interface, please download the ISO image =dangerzone-livecd-amd64-<version>.iso=
