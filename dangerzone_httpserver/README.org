...
* Is there a configuration file for the server?
...
|------------------+-----------------------------------------------------------------------|
| Linux & Others   | =XDG_CONFIG_HOME/dangerzone-httpserver/config.toml=                   |
| Mac OS           | =$HOME/Library/Application Support/dangerzone-httpserver/config.toml= |
| Windows          | =%APPDATA%\dangerzone-httpserver\config.toml=                         |
|------------------+-----------------------------------------------------------------------|
